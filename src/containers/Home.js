        ...
        <div className="swiper-container" style={{width:"100%"}}>
                <div className="swiper-wrapper">
                    ...
                    <div className="home1-slide-item swiper-slide" data-swiper-autoplay="5000" data-bg-image="/images/slider/home1/index_banner4.jpg">
                        ...
                        <div className="home1-slide-item swiper-slide" data-swiper-autoplay="5000" data-bg-image="/images/slider/home1/index_banner2.png"> </div>
                    </div>
                        ...
                        <div className="row learts-mb-n40">
                            ...
                            <div className="col-lg-6 col-md-6 col-12 learts-mb-40">
                                <div className="sale-banner2">
                                    <div className="inner">
                                        <div className="image"><img src="/images/banner/sale/in_person_classes2.PNG" alt="hello" /></div>
